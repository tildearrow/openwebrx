...
from csdr.module.toolbox import Rtl433Module, MultimonModule, DumpHfdlModule, DumpVdl2Module, Dump1090Module, AcarsDecModule, RedseaModule, SatDumpModule, HorusModule
...
class HorusDemodulator(ServiceDemodulator, DialFrequencyReceiver):
