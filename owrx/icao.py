...
ICAO_COUNTRIES = [
    ...
    IcaoCountry(0x08C000, 0x08CFFF, "DR Congo", "cd"),
    ...
    IcaoCountry(0x0BC000, 0x0BC3FF, "Saint Vincent and the Grenadines", "vc"),
    ...
    IcaoCountry(0x400300, 0x4003FF, "Turks and Caicos Islands", "tc"),
    ...
    IcaoCountry(0x480000, 0x487FFF, "Kingdom of the Netherlands", "nl"),
    ...
    IcaoCountry(0x681000, 0x6813FF, "Micronesia, Federated States of", "fm"),
